...
$ conda create -n myenv python=3.9  # 创建环境，并指定 Python 版本
```

## 激活环境

激活环境后，所有的库都会安装到该环境目录下，包括 Python 和 Pip
