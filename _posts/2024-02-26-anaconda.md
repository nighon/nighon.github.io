...
如果是 zsh 环境下报错 `conda not found`，先[运行初始化](https://gist.github.com/ryanorsinger/7d89ad58901b5590ec3e1f23d7b9f887?permalink_comment_id=3806602#gistcomment-3806602)
- Apple M1: `/opt/homebrew/anaconda3/bin/conda init zsh`
- Intel: `/usr/local/anaconda3/bin/conda init zsh`
...
```shell
$ conda create -n web python
$ conda activate web
$ (web) which python        # /Users/john/miniconda3/envs/web/bin/python

$ (web) python -m pip install Django
$ (web) which django-admin  # /Users/john/miniconda3/envs/web/bin/django-admin
```
