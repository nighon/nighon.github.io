...
<p class="codepen" data-height="400" data-default-tab="html,result" data-slug-hash="zYLgwdx" data-user="nighon" style="height: 400px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;">
...
<p class="codepen" data-height="400" data-default-tab="html,result" data-slug-hash="BaOEXYX" data-user="nighon" style="height: 400px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;">
...
<p class="codepen" data-height="400" data-default-tab="css,result" data-slug-hash="OJoYLMy" data-user="nighon" style="height: 400px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;">
